...
* [Snake.decideNext()](./src/model/Snake.cpp#L100): compute the next move direction ***D*** of the snake ***S1***.
...
* [Snake.findMinPath()](./src/model/Snake.cpp#L173): compute the shortest path between two positions.
...
* [Snake.findMaxPath()](./src/model/Snake.cpp#L217): compute the longest path between two positions.
