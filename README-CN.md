...
* 函数[Snake.decideNext()](./src/model/Snake.cpp#L110): 计算蛇***S1***的下一个移动方向***D***
...
* 函数[Map.findMinPath()](./src/model/Map.cpp#L169): 计算两个位置间的最短路径
...
* 函数[Map.findMaxPath()](./src/model/Map.cpp#L218): 计算两个位置间的最长路径
