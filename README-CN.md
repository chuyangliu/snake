...
* 函数[Snake.decideNext()](./src/model/Snake.cpp#L100): 计算蛇***S1***的下一个移动方向***D***
...
* 函数[Snake.findMinPath()](./src/model/Snake.cpp#L173): 计算两个位置间的最短路径
...
* 函数[Snake.findMaxPath()](./src/model/Snake.cpp#L217): 计算两个位置间的最长路径
